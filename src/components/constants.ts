...
export const FORM_FIELDS: FormFieldConfig[] = [
    ...
    },
    {
        ...
        required: true,
        type: 'checkbox',
        checkboxList: ['google', 'bing', 'facebook', 'instagram', 'linkedin', 'pinterest', 'twitter', 'youtube', 'newsletter', 'blog', 'partner', 'affiliate', 'appstore', 'playstore', 'adpl', 'tdmf', 'count_red'],
    },
    {
        name: 'utm_medium',
        label: 'UTM Medium',
